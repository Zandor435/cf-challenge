...
The "diplomat or divided loyalties" question resolved itself at the draft — he
took Stanford over 3.5, no hedge. The rest of the board reads exactly like the
guy who reads everything: a blue-blood over in Texas, a deep-cut Pac-12-remnant
over in Washington State, and the one team with real brand equity, USC, is the
one he doesn't trust.
...
The Aggie pick is the over, obviously — never neutral, and this year that means
bullish. The real tell is Texas Tech under 10.5: the market has decided they're
a contender, and the guy with two football-obsessed sons and in-house analytics
has decided the market is wrong.
...
Two ACC-region overs paired against two contrarian unders — one against a
service academy, one against a preseason blue-blood darling in Penn State. A
board built for material, not chalk, same as always.

- **running_gag:** Richmond and Georgia in the same heart. He'll defend both.
- **draft_tendency:** Picks for the story, not the spread. Penn State under is the story.
- **rival:** `zach`
...
Then he turned in a board of four straight overs, three of them ACC,
concentrated enough that the site itself had to turn off its own conference rule
to let it through — a financial planner's risk-tolerance question, answered by
going all-in.
...
LSU over is the heart pick, same as it's always been. Notre Dame under 11.5 is
betting against the market darling with the model he built himself — which is
either conviction or something to answer for in the standings.
...
- **pick_note** — retired. Pick humor is folded directly into backstory, running_gag, and draft_tendency, matching the browns convention.
